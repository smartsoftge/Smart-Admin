<?php class catalogi
{
  ...
  public function ganaxleba() {
    ...
    $sql = "UPDATE category SET  satauri=:satauri,surati=:surati,nomeri=:nomeri WHERE id = :id";
   ...
   $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
	...
	$sql = "INSERT INTO category ( satauri,surati,nomeri ) VALUES (:satauri,:surati,:nomeri)";
 ...
 public function postidanamogeba($postebi) 
 {
  ...
  public static function GetCatalogiAdmin( $gverdi, $kateg ) 
  {
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
	 ...
	 $sql = "SELECT * FROM  category  ORDER BY ID ASC LIMIT  $gverdi,30" ;
