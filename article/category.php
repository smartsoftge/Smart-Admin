...
<div style="height: 52px;">
    ...
    <div class=''>
		  ...
		  <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6; width:200px; ">  სურათი     </th>
...
<?php foreach (  $results['articles'] as $statiafor ) { ?>
		  ...
		  <a type="button" href="redcategoryhelp.php?ID=<?php  echo  $statiafor->ID ?>" class="btn btn-mini btn-info">რედაქტირება</a> 								
																		    <a type="button" href="redcategoryhelp.php?DEL=<?php  echo  $statiafor->ID ?>" class="btn btn-mini btn-danger">წაშლა</a> 
