...
<div class="control-group ">
                        <label  class="control-label"><b>სურათი<b style="color: red;">*</b>  
                            </b> </label>
                            <div class="controls">
...
<input type="text" name="surati" value="http://ss.com.ge/photos/files/smart-soft.jpg" onclick="openKCFinder(this)" value="0" style="width:210px;cursor:pointer" />			
