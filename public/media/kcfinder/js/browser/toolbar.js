...
browser.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:about"]').click(function() {
        var html = '<div class="box about">' +
            '<div class="head"><a href="http://ss.com.ge" target="_blank">SmartSoft</a> </div>';
        ...
        html +=
            ...
            '<div>Copyright &copy;2013 NIKA PHOTSKHVERIA</div>' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (browser.version < data.version)
                        span.html('<a href="http://ss.com.ge" target="_blank">' + browser.label("Download version {version} now!", {version: data.version}) + '</a>');
                    else
