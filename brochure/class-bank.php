...
class Bankebip
{
 ...
 public function postidanamogeba($postebi) 
 {
   ...
   public static function TitoBankebip( $id ) {
   ...
   $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
    ...
    if ( $row ) return new Bankebip( $row );
  ...
  public static function GetBankebip( $gverdi, $kateg ) 
  {
  ...
  public static function GetBankebipAdmin( $gverdi, $kateg ) 
  {
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
