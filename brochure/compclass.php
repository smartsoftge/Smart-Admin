...
class StatiaC
{
 ...
 $sql = "UPDATE kompaniebi SET  satauri=:satauri, surati=:surati,reziume=:reziume,statia=:statia,avtori=:avtori,kategoria=:kategoria,publish=:publish,metasityva=:metasityva,address=:address,web=:web,mail=:mail,phone=:phone,carte=:carte,clock=:clock,facebook=:facebook,twitter=:twitter,youtube=:youtube  WHERE id = :id";
  ...
  public static function getcompany() 
  {
    ...
    return ( array ("shedegi" => $list, "totalRows" => $totalRows[0] ) );
      ...
      public static function bankass($indif) 
  {
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
	 ...
	 $sql = "SELECT * FROM kompaniebi  WHERE kategoria  LIKE '%$indif%' " ;
   ...
   $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
	...
	$sql = "INSERT INTO kompaniebi ( satauri, surati, reziume, statia,tarigi,avtori,kategoria ,publish ,metasityva,address,web,mail,phone,carte,clock,facebook,twitter,youtube  ) VALUES (:satauri,:surati,:reziume, :statia , NOW() ,:avtori ,:kategoria , :publish , :metasityva ,:address,:web,:mail,:phone,:carte,:clock,:facebook,:twitter,:youtube  )";
