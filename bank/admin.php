...
{ $c = $_GET["kategoria"]; } 
  ...
  {
    $data = Statia::GetMtavari( $startfr,$_GET["mtavari"]);
  }
  else 
  {
   $data = Statia::GetStatiaAdmin( $startfr,$c);
  }
...
?>
			...
			<div  style="margin-left:10px;position:absolute; margin-left:0px; margin-top:2px;height:29px;" >All Companies:<b style="color:#478FED;"><? echo $totali; ?></b>
			</div>
                                    ...
                                    <a  style="  margin-top:-2px;" type="button" class="btn btn-info" href="add-article.php"> <i class="icon-plus icon-white"></i> Add</a>
                            </div>
        </div>
    </div>
    </div>
                ...
                <table class="table table-bordered table-hover list table-condensed">
                    <thead>
                        <tr>
                                         ...
                                         <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6; width:700px; ">  Company     </th>
                                        
                                      
										 <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6;   width:140px;  ">Author </th>
							             <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6; width:70px;"> View    </th>
										 <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6; width:100px;"> Date    </th>
							             <th style="cursor:pointer; text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6;"> Status          </th>
					                     <th style="cursor:default;  text-align:center; color:#333333;text-shadow: 0 1px 0 #FFFFFF;  background-color: #e6e6e6;width:150px; "> Action</th>
                                                                                    </tr>
                    </thead>
                    <tbody>
        ...
        <!-- <td style="text-align:center;">  <?php echo   date('Y-d-m H:i', strtotime($statiafor->tarigi))?>      </td>-->
         <td style="text-align:center;">  <?php echo $statiafor->avtori?>       </td> 
										   <td style="text-align:center; width:40px;"> <?php echo $statiafor->naxva?>        </td>
										    ...
										    <td style="text-align:center; width:80px;">  <?php echo   date('Y-d-m H:i', strtotime($statiafor->tarigi))?>   </td>
							 ...
							 <?php if($_SESSION['jgufi'] != 3) 
								  {
								echo '<a type="button" href="redaktirebahelper.php?ID= '.$statiafor->ID .'" class="btn btn-mini btn-info">Edit</a>';
					        	echo '<a type="button" href="redaktirebahelper.php?DEL='.$statiafor->ID .'" class="btn btn-mini btn-danger">Delete </a>';
                              	  }	
								  else 
								  {
								   echo "ups";
